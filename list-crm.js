...
sheets.spreadsheets.values.get({ spreadsheetId: '14ldpC7mD1wYjouSiR9gizl--fPFcIowGGzkQdkxQNvQ', range: '員工CRM!A:Z' }).then(res => {
  console.log('員工CRM data:', res.data.values ? res.data.values.slice(0, 5) : 'No data');
}).catch(console.error);
