...
export default function BasicMissionPage() {
  ...
  return (
    <div className="bg-background text-on-background font-body-lg overflow-x-hidden selection:bg-primary-container selection:text-on-primary-container font-display min-h-[calc(100dvh_-_var(--sat))] pb-20">
      <header className="fixed top-[var(--sat)] w-full z-50 flex justify-between items-center shrink-0 h-16 bg-surface/90 backdrop-blur-md border-b border-primary/30 shadow-[0_8px_20px_rgba(243,156,18,0.3)] px-4">
